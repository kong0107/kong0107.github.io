...
* 可以公開回應的問題，可在[向我發問](https://kong-sex.tumblr.com/ask)提出。
* 不回應下列訊息：
  1. 單純打招呼，如「Hi」、「安安」、「你好（啊）」。
  1. 「在嗎」
  1. 「可以認識嗎？」
  1. 「很高興認識你。」
  1. 「為什麼不回應」
  1. 「？」
  1. 沒有提及待解決的需求或問題。
* 另請參閱[我不喜歡被問的問題](tags/地雷/)。


# 發問
常見問題已盡量列於[問與答](https://kong-sex.tumblr.com/post/150394951301/faq)中。
若有未提及的問題，歡迎用 Tumblr 的「[向我發問](https://kong-sex.tumblr.com/ask)」功能提出。


# 邀約
約炮請參閱[關於老大](boss.html)中「約炮喜好與注意事項」說明。
其他邀約亦請把握前述「聯絡原則」，直接說明意欲邀約的人、事、時、地，並說明是否有交通費和酬勞。
我平常在台北，時間則可在[我的 Google 日曆][calendar]確認。
...
# 各平臺與帳號
有警告標示的連結包含客觀上足以刺激或滿足性慾，而令一般人感覺不堪呈現於眾或不能忍受而排拒之猥褻資訊，有害兒童及少年身心發展。
{% showContacts %}
