...
參考資料
Eddy@Joomla!藏經閣 - Javascript Module Pattern
JavaScript物件導向繼承：以prototype方式繼承中需要呼叫constructor的問題 : 布丁布丁吃什麼？
John Resig - JavaScript Getters and Setters
override - Overriding a JavaScript function while referencing the original - Stack Overflow
